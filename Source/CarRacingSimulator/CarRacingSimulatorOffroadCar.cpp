...
#include "CarRacingSimulatorOffroadCar.h"
#include "CarRacingSimulatorOffroadWheelFront.h"
#include "CarRacingSimulatorOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACarRacingSimulatorOffroadCar::ACarRacingSimulatorOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarRacingSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarRacingSimulatorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarRacingSimulatorOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarRacingSimulatorOffroadWheelRear::StaticClass();
