...
#include "CarRacingSimulatorSportsCar.h"
#include "CarRacingSimulatorSportsWheelFront.h"
#include "CarRacingSimulatorSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarRacingSimulatorSportsCar::ACarRacingSimulatorSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarRacingSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarRacingSimulatorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarRacingSimulatorSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarRacingSimulatorSportsWheelRear::StaticClass();
